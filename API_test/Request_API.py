...
def get_request():
    ...
    # to print json data in readable formate
...
def post_request():
    ...
    assert json_data["name"] == "Rama Automation"
...
def put_request(user_id):
    ...
    assert json_data["name"] == "Rama Automation Labs"
